...
import DeleteCreditNote from '@bigcapital/server/services/CreditNotes/DeleteCreditNote';
import DeletreCreditNoteApplyToInvoices from '@bigcapital/server/services/CreditNotes/DeleteCreditNoteApplyToInvoices';
import DeleteRefundCreditNote from '@bigcapital/server/services/CreditNotes/DeleteRefundCreditNote';
import EditCreditNote from '@bigcapital/server/services/CreditNotes/EditCreditNote';
import GetCreditNote from '@bigcapital/server/services/CreditNotes/GetCreditNote';
import GetCreditNoteAssociatedAppliedInvoices from '@bigcapital/server/services/CreditNotes/GetCreditNoteAssociatedAppliedInvoices';
import GetCreditNoteAssociatedInvoicesToApply from '@bigcapital/server/services/CreditNotes/GetCreditNoteAssociatedInvoicesToApply';
import GetRefundCreditTransaction from '@bigcapital/server/services/CreditNotes/GetRefundCreditNoteTransaction';
import ListCreditNoteRefunds from '@bigcapital/server/services/CreditNotes/ListCreditNoteRefunds';
import ListCreditNotes from '@bigcapital/server/services/CreditNotes/ListCreditNotes';
import OpenCreditNote from '@bigcapital/server/services/CreditNotes/OpenCreditNote';
...
export default class PaymentReceivesController extends BaseController {
  ...
  private newCreditNote = async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      const creditNote = await this.createCreditNoteService.newCreditNote(tenantId, creditNoteDTO);
