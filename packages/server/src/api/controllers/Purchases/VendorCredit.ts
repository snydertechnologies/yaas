...
import EditVendorCredit from '@bigcapital/server/services/Purchases/VendorCredits/EditVendorCredit';
import GetVendorCredit from '@bigcapital/server/services/Purchases/VendorCredits/GetVendorCredit';
import ListVendorCredits from '@bigcapital/server/services/Purchases/VendorCredits/ListVendorCredits';
import OpenVendorCredit from '@bigcapital/server/services/Purchases/VendorCredits/OpenVendorCredit';
import CreateRefundVendorCredit from '@bigcapital/server/services/Purchases/VendorCredits/RefundVendorCredits/CreateRefundVendorCredit';
import DeleteRefundVendorCredit from '@bigcapital/server/services/Purchases/VendorCredits/RefundVendorCredits/DeleteRefundVendorCredit';
import GetRefundVendorCredit from '@bigcapital/server/services/Purchases/VendorCredits/RefundVendorCredits/GetRefundVendorCredit';
import ListVendorCreditRefunds from '@bigcapital/server/services/Purchases/VendorCredits/RefundVendorCredits/ListRefundVendorCredits';
...
export default class VendorCreditController extends BaseController {
  ...
  private newVendorCredit = async (req: Request, res: Response, next: NextFunction) => {
    ...
    try {
      const vendorCredit = await this.createVendorCreditService.newVendorCredit(tenantId, vendorCreditCreateDTO);
