import type { IColumnMapperMeta, ITableRow } from '@/interfaces';
...
function getAccessor(object, accessor) {
  return typeof accessor === 'function' ? accessor(object) : get(object, accessor);
}

export function tableRowMapper(object: Object, columns: IColumnMapperMeta[], rowMeta): ITableRow {
