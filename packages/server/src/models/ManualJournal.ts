...
import { DEFAULT_VIEWS } from '@bigcapital/server/services/ManualJournals/constants';
...
export default class ManualJournal extends mixin(TenantModel, [ModelSetting, CustomViewBaseModel, ModelSearchable]) {
  /**
   * Table name.
   */
