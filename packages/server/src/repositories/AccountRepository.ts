...
export default class AccountRepository extends TenantRepository {
   ...
   * @returns
   */
  findOrCreateAccountReceivable = async (currencyCode: string = '', extraAttrs = {}, trx?: Knex.Transaction) => {
  ...
  findOrCreateAccountsPayable = async (currencyCode: string = '', extraAttrs = {}, trx?: Knex.Transaction) => {
    let result = await this.model
      .query(trx)
      .onBuild((query) => {
        if (currencyCode) {
