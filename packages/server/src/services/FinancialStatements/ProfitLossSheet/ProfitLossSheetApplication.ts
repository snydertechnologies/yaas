import { IProfitLossSheetQuery, IProfitLossSheetTable } from '@bigcapital/libs-backend';
...
export class ProfitLossSheetApplication {
   ...
   */
  public table(tenantId: number, query: IProfitLossSheetQuery): Promise<IProfitLossSheetTable> {
