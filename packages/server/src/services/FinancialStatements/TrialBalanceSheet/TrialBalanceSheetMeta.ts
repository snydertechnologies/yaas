import { ITrialBalanceSheetMeta, ITrialBalanceSheetQuery } from '@bigcapital/libs-backend';
...
export class TrialBalanceSheetMeta {
   ...
   */
  public async meta(tenantId: number, query: ITrialBalanceSheetQuery): Promise<ITrialBalanceSheetMeta> {
