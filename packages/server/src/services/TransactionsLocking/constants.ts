import { ITransactionsLockingSchema, TransactionsLockingGroup } from '@bigcapital/libs-backend';
...
export const ERRORS = {
  ...
  TRANSACTIONS_LOCKING_MODULE_NOT_FOUND: 'TRANSACTIONS_LOCKING_MODULE_NOT_FOUND',
};
...
export function getTransactionsLockingSchemaMeta(module: TransactionsLockingGroup): ITransactionsLockingSchema {
