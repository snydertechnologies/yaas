import { ICreditNoteCreatedPayload, ICreditNoteCreatingPayload, ICreditNoteNewDTO } from '@/interfaces';
...
export default class CreateCreditNote extends BaseCreditNotes {
   ...
   * @param creditNoteDTO
   */
  public newCreditNote = async (tenantId: number, creditNoteDTO: ICreditNoteNewDTO, trx?: Knex.Transaction) => {
