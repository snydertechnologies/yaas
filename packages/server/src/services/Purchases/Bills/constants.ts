...
export const DEFAULT_VIEWS = [
  ...
  },
  {
    ...
    slug: 'opened',
    rolesLogicExpression: '1',
    roles: [{ index: 1, fieldKey: 'status', comparator: 'equals', value: 'opened' }],
    columns: DEFAULT_VIEW_COLUMNS,
  },
  {
    name: 'Unpaid',
  ...
  },
  {
    ...
    slug: 'overdue',
    rolesLogicExpression: '1',
    roles: [{ index: 1, fieldKey: 'status', comparator: 'equals', value: 'overdue' }],
    columns: DEFAULT_VIEW_COLUMNS,
  },
  {
    name: 'Partially paid',
...
export const BillsSampleData = [
  ...
  },
  {
    ...
    Quantity: 200,
    Rate: 50,
    'Line Description': 'Nesciunt in adipisci quia ab reiciendis nam sed saepe consequatur.',
  },
  {
    'Bill No.': 'B-103',
    'Reference No.': 'REF0',
