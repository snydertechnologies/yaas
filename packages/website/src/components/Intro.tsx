...
export default function Page() {
  return (
    <div className={'text-center py-[60px] md:py-[80px] animate__animated animate__fadeIn'}>
      <div className="container lg-auto mx-auto px-4">
        ...
        >
          Control your business bookkeeping with automated accounting, to run intelligent reports for faster
          decision-making.
        </h2>

        <div className={'text-center flex gap-3 md:gap-4 justify-center flex-col md:flex-row'}>
          <Link
            className={
