...
export default function BigcapitalAlt({ width, height, fill, className }: SVGProps<SVGSVGElement>) {
  return (
    <svg
      ...
      className={className}
    >
      <path fill="currentColor" d="M56,3.16,61.33,8.5,31.94,37.9l-5.35-5.35Z" transform="translate(-0.14 -3.16)"></path>
      <path
        fill="currentColor"
      ...
      <path
        ...
        transform="translate(-0.14 -3.16)"
      ></path>
      <path fill="currentColor" d="M289.72,38.87V6.57h6.72v32.3Z" transform="translate(-0.14 -3.16)"></path>
      <path fill="currentColor" d="M302.06,38.87V31.79h7.17v7.08Z" transform="translate(-0.14 -3.16)"></path>
    </svg>
  );
}
