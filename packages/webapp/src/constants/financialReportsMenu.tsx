    ...
    reports: [
      {
        ...
        desc: <T id={'reports_a_company_s_assets_liabilities_and_shareholders'} />,
      ...
      },
      {
        ...
        desc: <T id={'summarizes_the_credit_and_debit_balance_of_each_account'} />,
      ...
      },
      {
        ...
        desc: <T id={'reports_inflow_and_outflow_of_cash_and_cash_equivalents'} />,
      ...
      },
      {
        ...
        desc: <T id={'summarize_total_unpaid_balances_of_customers_invoices'} />,
    ...
    reports: [
      {
        ...
        desc: <T id={'summarize_the_business_s_purchase_items_quantity_cost_and_average'} />,
      ...
      },
      {
        ...
        desc: <T id={'summarize_the_business_s_sold_items_quantity_income_and_average_income_rate'} />,
      ...
      },
      {
        ...
        desc: <T id={'summerize_the_total_amount_of_each_customer_owes_your_business'} />,
      ...
      },
      {
        ...
        desc: <T id={'summerize_the_total_amount_your_business_owes_each_vendor'} />,
      ...
      },
      {
        ...
        desc: <T id={'reports_every_transaction_going_in_and_out_of_each_customer'} />,
      ...
      },
      {
        ...
        desc: <T id={'reports_every_transaction_going_in_and_out_of_each_vendor_supplier'} />,
      ...
      },
      {
        ...
        desc: <T id={'reports_every_transaction_going_in_and_out_of_your_items'} />,
