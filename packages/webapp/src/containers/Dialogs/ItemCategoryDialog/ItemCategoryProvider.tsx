...
function ItemCategoryProvider({ itemCategoryId, dialogName, ...props }) {
  const { data: itemCategory, isFetching: isItemCategoryLoading } = useItemCategory(itemCategoryId, {
  ...
  return (
    <DialogContent isLoading={isItemCategoryLoading} name={'item-category-form'}>
