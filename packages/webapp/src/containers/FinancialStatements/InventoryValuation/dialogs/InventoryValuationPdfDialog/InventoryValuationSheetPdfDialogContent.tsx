...
import { useInventoryValuationPdf } from '@bigcapital/webapp/hooks/query';
  ...
  return (
    <DialogContent>
      <div className="dialog__header-actions">
        ...
        <AnchorButton href={pdfUrl} download={'inventory-valuation-summary.pdf'} minimal={true} outlined={true}>
