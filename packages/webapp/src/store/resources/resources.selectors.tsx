...
export const getResourceFieldsFactory = () =>
  createSelector(resourceFieldsIdsSelector, resourceFieldsItemsSelector, (fieldsIds, fieldsItems) => {
...
export const getResourceDataFactory = () =>
  createSelector(resourceDataSelector, resourceDataIdsSelector, (resourceData, resourceDataIds) => {
