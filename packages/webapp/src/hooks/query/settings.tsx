...
export function useSettingsInvoices(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_INVOICES], { group: 'sale_invoices' }, props);
}
...
export function useSettingsEstimates(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_ESTIMATES], { group: 'sale_estimates' }, props);
}
...
export function useSettingsPaymentReceives(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_PAYMENT_RECEIVES], { group: 'payment_receives' }, props);
}
...
export function useSettingsReceipts(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_RECEIPTS], { group: 'sale_receipts' }, props);
}
...
export function useSettingsManualJournals(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_MANUAL_JOURNALS], { group: 'manual_journals' }, props);
}
...
export function useSettingsItems(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_ITEMS], { group: 'items' }, props);
}
...
export function useSettingCashFlow(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_CASHFLOW], { group: 'cashflow' }, props);
}
...
export function useSettingsCreditNotes(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_CREDIT_NOTES], { group: 'credit_note' }, props);
}
/**
 * Retrieve vendor credit settings.
 */
export function useSettingsVendorCredits(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_VENDOR_CREDITS], { group: 'vendor_credit' }, props);
}
...
export function useSettingsWarehouseTransfers(props) {
  return useSettingsQuery([t.SETTING, t.SETTING_WAREHOUSE_TRANSFERS], { group: 'warehouse_transfers' }, props);
}
...
export function useSettingEditSMSNotification(props) {
  ...
  return useMutation((values) => apiRequest.post(`settings/sms-notification`, values), {
    onSuccess: () => {
